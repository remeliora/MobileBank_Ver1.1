...
namespace WindowsFormsApp1.Forms
{
    public partial class CreditForm : Form
    {
        ...
        private void CreditForm_Load(object sender, EventArgs e)
        {
            ...
            TextBoxSum.Text = bunifuHSlider1.Value.ToString();
            TextBoxMonth.Text = bunifuHSlider2.Value.ToString();
        ...
        private void TextBoxSum_Click(object sender, EventArgs e)
        {
            ...
            bunifuHSlider1.Value = Convert.ToInt32(TextBoxSum.Text);
            calculateCredit();
        }
        ...
        private void TextBoxMonth_Click(object sender, EventArgs e)
        {
            ...
            bunifuHSlider2.Value = Convert.ToInt32(TextBoxMonth.Text);
            calculateCredit();
        }
